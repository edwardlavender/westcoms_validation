...
This repository contains methods, written in `R` and organised as an `R Project`, for Lavender et al. (in review). Benthic animal-borne sensors and citizen science combine to validate ocean modelling. 
...
Lavender, E. et al. (in review). Benthic animal-borne sensors and citizen science combine to validate ocean modelling. 